...
router.get('/:scheduleId/edit', authenticationEnsurer, (req, res, next) => {
  ...
  Schedule.findOne({ where: { scheduleId: req.params.scheduleId } }).then((schedule) => {
...
function deleteScheduleAggregate(scheduleId, done, err) {
  ...
  const promiseCommentDestroy = Comment.findAll({ where: { scheduleId: scheduleId } }).then((comments) => {
